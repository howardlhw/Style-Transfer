...
def main():
    ckptFiles = ['./la_muse.ckpt','./rain-princess.ckpt','./scream.ckpt','./udnie.ckpt','./wave.ckpt','./wreck.ckpt']
    outpath = ['_muse.jpg', '_rain.jpg', '_scream.jpg', '_udnie.jpg',  '_wave.jpg', '_wreck.jpg']
    parser = build_parser()
...
##                        batch_size=opts.batch_size)
        out_path = opts.in_path[:-4] + outpath[i]
        ffwd_to_img(opts.in_path, out_path, ckpt, device=opts.device)
        i += 1
        print("one down")
